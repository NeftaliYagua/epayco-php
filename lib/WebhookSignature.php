...
abstract class WebhookSignature
{
    ...
    /**
     * Verifies the signature header sent by Epayco. Throws an
     * Exception\SignatureVerificationException exception if the verification fails for
     * any reason.
     *
     * @param string $payload the payload sent by Epayco
     ...
     *
     * The current scheme used by Epayco ("v1") is HMAC/SHA-256.
     *

 ...
 * href="https://epayco.com/docs/api#products">Products</a> help you track
 ...
 * a subscription</a>, <a
 * href="https://epayco.com/docs/billing/invoices/create">create an invoice</a>,
 * and more about <a href="https://epayco.com/docs/billing/prices-guide">products
 * and prices</a>.
 *
 ...
 * @property string|\Epayco\Product $product The ID of the product this price is associated with.
 * @property null|\Epayco\EpaycoObject $recurring The recurring components of a price such as <code>interval</code> and <code>usage_type</code>.
 ...
 * @property null|\Epayco\EpaycoObject $transform_quantity Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.

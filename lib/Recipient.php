...
/**
 * With <code>Recipient</code> objects, you can transfer money from your Epayco
 ...
 * @property null|\Epayco\BankAccount $active_account Hash describing the current account on the recipient, if there is one.
 * @property null|\Epayco\Collection $cards
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string|\Epayco\Card $default_card The default card to use for creating transfers to this recipient.

 ...
 * specific run parameters. Once the object is created, Epayco begins processing
 ...
 * href="https://epayco.com/docs/reporting/statements/api">API Access to
 * Reports</a>.
 *
 ...
 * @property \Epayco\EpaycoObject $parameters
 * @property string $report_type The ID of the <a href="https://epayco.com/docs/reports/report-types">report type</a> to run, such as <code>&quot;balance.summary.1&quot;</code>.
 * @property null|\Epayco\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \Epayco\ApiResource
{

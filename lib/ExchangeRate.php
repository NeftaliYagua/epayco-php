...
/**
 * <code>Exchange Rate</code> objects allow you to determine the rates that Epayco
 ...
 * @property \Epayco\EpaycoObject $rates Hash where the keys are supported currencies and the values are the exchange rate at which the base id currency converts to the key currency.
 */

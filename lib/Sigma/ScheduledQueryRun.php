 ...
 * @property int $data_load_time When the query was run, Sigma contained a snapshot of your Epayco data at this time.
 * @property \Epayco\EpaycoObject $error
 * @property null|\Epayco\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \Epayco\ApiResource
{

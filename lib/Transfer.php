...
/**
 * A <code>Transfer</code> object is created when you move funds between Epayco
 * accounts as part of Connect.
 *
 * Before April 6, 2017, transfers also represented movement of funds from a Epayco
 * account to a card or bank account. This behavior has since been split out into a
 * <a href="https://epayco.com/docs/api#payout_object">Payout</a> object, with
 * corresponding payout endpoints. For more information, read about the <a
 * href="https://epayco.com/docs/transfer-payout-split">transfer/payout split</a>.
 *
 * Related guide: <a
 * href="https://epayco.com/docs/connect/charges-transfers">Creating Separate
 ...
 * @property null|string|\Epayco\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\Epayco\Account $destination ID of the Epayco account the transfer was sent to.
 * @property string|\Epayco\Charge $destination_payment If the destination is a Epayco account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \Epayco\Collection $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\Epayco\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     * @throws \Epayco\Exception\ApiErrorException if the request fails
     *
     * @return \Epayco\Collection the list of transfer reversals
     */

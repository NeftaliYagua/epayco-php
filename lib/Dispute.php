 ...
 * documentation.
 *
 * Related guide: <a href="https://epayco.com/docs/disputes">Disputes and
 * Fraud</a>.
 *
 ...
 * @property \Epayco\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your Epayco account as a result of this dispute.
 * @property string|\Epayco\Charge $charge ID of the charge that was disputed.
 ...
 * @property \Epayco\EpaycoObject $evidence_details
 * @property bool $is_charge_refundable If true, it is still possible to refund the disputed payment. Once the payment has been fully refunded, no further funds will be withdrawn from your Epayco account as a result of this dispute.
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \Epayco\Dispute the closed dispute
     */

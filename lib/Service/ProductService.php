...
class ProductService extends \Epayco\Service\AbstractService
{
    /**
     ...
     * either a product creation request or the product list, and Epayco will return

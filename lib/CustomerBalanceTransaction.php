 ...
 * href="https://epayco.com/docs/api/customers/object#customer_object-balance"><code>balance</code></a>
 ...
 * <a href="https://epayco.com/docs/api/customers/update">update customer API</a>,
 ...
 *
 * Related guide: <a
 * href="https://epayco.com/docs/billing/customer/balance">Customer Balance</a> to
 * learn more.
 *
 ...
 * @property null|string|\Epayco\CreditNote $credit_note The ID of the credit note (if any) related to the transaction.
 ...
 * @property string|\Epayco\Customer $customer The ID of the customer the transaction belongs to.
 ...
 * @property null|string|\Epayco\Invoice $invoice The ID of the invoice (if any) related to the transaction.

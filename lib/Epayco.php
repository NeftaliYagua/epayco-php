...
class Epayco
{
    /** @var string The Epayco API key to be used for requests. */
    public static $apiKey;

    /** @var string The Epayco client_id to be used for Connect requests. */
    ...
    /** @var float Maximum delay between retries, in seconds, that will be respected from the Epayco API */
    ...
    /**
     * @return string | null The Epayco account ID for connected account
     *   requests
     */
    ...
    /**
     * @param string $accountId the Epayco account ID to set for connected
     *   account requests
     */
    ...
    /**
     * @return float Maximum delay between retries, in seconds, that will be respected from the Epayco API
     */
     ...
     *
     * Client telemetry enables timing and request metrics to be sent back to Epayco as an HTTP Header
     * with the current request. This enables Epayco to do latency and metrics analysis without adding extra

 ...
 * conjunction with <a href="https://epayco.com/docs/api#prices">Prices</a> to
 ...
 * href="https://epayco.com/docs/payments/checkout/client#create-products">one-time
 ...
 * @property null|\Epayco\EpaycoObject $package_dimensions The dimensions of this product for shipping purposes. A SKU associated with this product can override this value by having its own <code>package_dimensions</code>. Only applicable to products of <code>type=good</code>.
 ...
 * @property null|string $unit_label A label that represents units of this product in Epayco and on customers’ receipts and invoices. When set, this will be included in associated invoice line item descriptions.

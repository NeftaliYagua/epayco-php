 ...
 * @coversNothing
 */
final class EpaycoTelemetryTest extends \PHPUnit\Framework\TestCase
{
    use TestHelper;
    ...
    public function testNoTelemetrySentIfNotEnabled()
    {
        ...
        Charge::all();
        static::assertArrayNotHasKey('X-Epayco-Client-Telemetry', $requestheaders);
    ...
    {
        Epayco::setEnableTelemetry(true);
        ...
        Charge::all();
        static::assertArrayHasKey('X-Epayco-Client-Telemetry', $requestheaders);

        $data = \json_decode($requestheaders['X-Epayco-Client-Telemetry'], true);

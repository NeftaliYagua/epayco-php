...
final class CardTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testIsListable()
    {
        ...
        static::assertInstanceOf(\Epayco\Issuing\Card::class, $resources->data[0]);
    }
    ...
    public function testIsRetrievable()
    {
        ...
        static::assertInstanceOf(\Epayco\Issuing\Card::class, $resource);
    }
    ...
    public function testCanRetrieveDetails()
    {
        ...
        static::assertInstanceOf(\Epayco\Issuing\CardDetails::class, $details);
    }
}

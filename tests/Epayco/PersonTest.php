...
final class PersonTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $resource = \Epayco\Account::retrievePerson(self::TEST_ACCOUNT_ID, self::TEST_RESOURCE_ID);
        static::assertSame(
    ...
    {
        $this->expectException(\Epayco\Exception\BadMethodCallException::class);
    ...
    public function testIsSaveable()
    {
        ...
        $resource->save();
        static::assertSame(\Epayco\Person::class, \get_class($resource));
    }

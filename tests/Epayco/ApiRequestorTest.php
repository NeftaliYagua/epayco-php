...
use Epayco\HttpClient\CurlClient;

/**
 * @internal
 * @covers \Epayco\ApiRequestor
 */
final class ApiRequestorTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $reflector = new \ReflectionClass(\Epayco\ApiRequestor::class);
    ...
    public function testDefaultHeaders()
    {
        ...
        Epayco::setAppInfo('MyTestApp', '1.2.34', 'https://mytestapp.example', 'partner_1234');
        $apiKey = 'sk_test_notarealkey';
        $clientInfo = ['httplib' => 'testlib 0.1.2'];

        $headers = $method->invoke(null, $apiKey, $clientInfo);

        $ua = \json_decode($headers['X-Epayco-Client-User-Agent']);
        ...
        static::assertSame(
            $headers['User-Agent'],
            'Epayco/v1 PhpBindings/' . Epayco::VERSION . ' MyTestApp/1.2.34 (https://mytestapp.example)'
        );
    ...
    public function testRaisesInvalidRequestErrorOn400()
    {
        ...
        try {
            ...
            static::assertSame('id', $e->getEpaycoParam());
        } catch (\Exception $e) {
    ...
    public function testRaisesCardErrorOn402()
    {
        ...
        try {
            ...
            static::assertSame('card_declined', $e->getEpaycoCode());
            static::assertSame('generic_decline', $e->getDeclineCode());
            static::assertSame('exp_month', $e->getEpaycoParam());
        } catch (\Exception $e) {
            static::fail('Unexpected exception: ' . \get_class($e));
        }
    }
    ...
    public function testRaisesOAuthInvalidRequestError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('invalid_request', $e->getEpaycoCode());
    ...
    public function testRaisesOAuthInvalidClientError()
    {
        ...
        try {
            ...
            static::assertSame(401, $e->getHttpStatus());
            static::assertSame('invalid_client', $e->getEpaycoCode());
    ...
    public function testRaisesOAuthInvalidGrantError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('invalid_grant', $e->getEpaycoCode());
    ...
    public function testRaisesOAuthInvalidScopeError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('invalid_scope', $e->getEpaycoCode());
    ...
    public function testRaisesOAuthUnsupportedGrantTypeError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('unsupported_grant_type', $e->getEpaycoCode());
        } catch (\Exception $e) {
            static::fail('Unexpected exception: ' . \get_class($e));
        }
    }
    ...
    public function testRaisesOAuthUnsupportedResponseTypeError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('unsupported_response_type', $e->getEpaycoCode());
    ...
    public function testHeaderEpaycoVersionGlobal()
    {
        Epayco::setApiVersion('2222-22-22');
        $this->stubRequest(
            'POST',
            '/v1/charges',
            [],
            [
                'Epayco-Version: 2222-22-22',
            ],
            false,
            [
                'id' => 'ch_123',
    ...
    public function testHeaderEpaycoVersionRequestOptions()
    {
        $this->stubRequest(
            'POST',
            '/v1/charges',
        ...
        Charge::create([], ['epayco_version' => '2222-22-22']);
    }

    public function testHeaderEpaycoAccountGlobal()
    {
        Epayco::setAccountId('acct_123');
        $this->stubRequest(
            'POST',
            '/v1/charges',
            [],
            [
                'Epayco-Account: acct_123',
            ],
            false,
            [
                'id' => 'ch_123',
    ...
    public function testHeaderEpaycoAccountRequestOptions()
    {
        $this->stubRequest(
            'POST',
            '/v1/charges',
        ...
        Charge::create([], ['epayco_account' => 'acct_123']);
    }

...
/**
 * @internal
 * @covers \Epayco\Service\SubscriptionItemService
 */
final class SubscriptionItemServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\SubscriptionItem::class, $resources->data[0]);
    }
    ...
    public function testRetrieve()
    {
        ...
        static::assertInstanceOf(\Epayco\SubscriptionItem::class, $resource);
    }
    ...
    public function testListUsageRecordSummaries()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Epayco\UsageRecordSummary::class, $resources->data[0]);
    }
}

...
/**
 * @internal
 * @covers \Epayco\Service\OAuthService
 */
final class OAuthServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->client = new \Epayco\EpaycoClient(['api_key' => 'sk_test_123', 'api_base' => MOCK_URL, 'client_id' => 'ca_123']);
    ...
    public function testAuthorizeUrl()
    {
        ...
        static::assertSame('test@example.com', $params['epayco_user']['email']);
        static::assertSame('https://example.com/profile/test', $params['epayco_user']['url']);
        static::assertSame('US', $params['epayco_user']['country']);
    }
    ...
    public function testToken()
    {
        ...
        $this->stubRequest(
            ...
            [
                ...
                'epayco_user_id' => 'acct_test',
                'epayco_publishable_key' => 'pk_test',
            ],
            200,
    ...
    public function testDeauthorize()
    {
        ...
        static::assertSame('acct_test', $resp->epayco_user_id);
    }
}

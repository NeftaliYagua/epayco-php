...
/**
 * @internal
 * @covers \Epayco\Service\SourceService
 */
final class SourceServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAllTransactions()
    {
        ...
        static::assertInstanceOf(\Epayco\SourceTransaction::class, $resources->data[0]);
    }
    ...
    public function testCreate()
    {
        ...
        static::assertInstanceOf(\Epayco\Source::class, $resource);
    }

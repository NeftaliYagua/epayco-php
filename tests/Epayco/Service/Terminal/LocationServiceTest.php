...
/**
 * @internal
 * @covers \Epayco\Service\Terminal\LocationService
 */
final class LocationServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\Terminal\Location::class, $resources->data[0]);
    }
    ...
    public function testCreate()
    {
        ...
        static::assertInstanceOf(\Epayco\Terminal\Location::class, $resource);
    }

...
/**
 * @internal
 * @covers \Epayco\Service\Terminal\ReaderService
 */
final class ReaderServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\Terminal\Reader::class, $resources->data[0]);
    }
    ...
    public function testCreate()
    {
        ...
        static::assertInstanceOf(\Epayco\Terminal\Reader::class, $resource);
    }

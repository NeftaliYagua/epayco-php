...
/**
 * @internal
 * @covers \Epayco\Service\InvoiceService
 */
final class InvoiceServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\Invoice::class, $resources->data[0]);
    }
    ...
    public function testCreate()
    {
        ...
        static::assertInstanceOf(\Epayco\Invoice::class, $resource);
    }
    ...
    public function testUpcomingLines()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Epayco\InvoiceLineItem::class, $resources->data[0]);
    }

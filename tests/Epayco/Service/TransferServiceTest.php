...
/**
 * @internal
 * @covers \Epayco\Service\TransferService
 */
final class TransferServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\Transfer::class, $resources->data[0]);
    }
    ...
    public function testAllReversals()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Epayco\TransferReversal::class, $resources->data[0]);
    }

    public function testCancel()
    {
        // epayco-mock does not support this anymore so we stub it
        $this->stubRequest(
            'post',
        ...
        static::assertInstanceOf(\Epayco\Transfer::class, $resource);
    }
    ...
    public function testCreateReversal()
    {
        ...
        static::assertInstanceOf(\Epayco\TransferReversal::class, $resource);
    }

...
/**
 * @internal
 * @covers \Epayco\Service\ProductService
 */
final class ProductServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\Product::class, $resources->data[0]);
    }
    ...
    public function testCreate()
    {
        ...
        static::assertInstanceOf(\Epayco\Product::class, $resource);
    }

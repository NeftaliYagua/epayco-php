...
/**
 * @internal
 * @covers \Epayco\Service\Issuing\AuthorizationService
 */
final class AuthorizationServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\Issuing\Authorization::class, $resources->data[0]);
    }
    ...
    public function testApprove()
    {
        ...
        static::assertInstanceOf(\Epayco\Issuing\Authorization::class, $resource);
    }

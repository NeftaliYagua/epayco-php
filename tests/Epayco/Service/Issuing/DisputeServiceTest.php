...
/**
 * @internal
 * @covers \Epayco\Service\Issuing\DisputeService
 */
final class DisputeServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\Issuing\Dispute::class, $resources->data[0]);
    }
    ...
    public function testCreate()
    {
        ...
        static::assertInstanceOf(\Epayco\Issuing\Dispute::class, $resource);
    }

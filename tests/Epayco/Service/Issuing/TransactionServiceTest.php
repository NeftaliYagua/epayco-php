...
/**
 * @internal
 * @covers \Epayco\Service\Issuing\TransactionService
 */
final class TransactionServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\Issuing\Transaction::class, $resources->data[0]);
    }
    ...
    public function testRetrieve()
    {
        ...
        static::assertInstanceOf(\Epayco\Issuing\Transaction::class, $resource);
    }

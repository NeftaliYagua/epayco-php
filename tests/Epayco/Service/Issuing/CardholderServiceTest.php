...
/**
 * @internal
 * @covers \Epayco\Service\Issuing\CardholderService
 */
final class CardholderServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\Issuing\Cardholder::class, $resources->data[0]);
    }
    ...
    public function testCreate()
    {
        ...
        static::assertInstanceOf(\Epayco\Issuing\Cardholder::class, $resource);
    }

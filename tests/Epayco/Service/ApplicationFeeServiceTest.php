...
/**
 * @internal
 * @covers \Epayco\Service\ApplicationFeeService
 */
final class ApplicationFeeServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\ApplicationFee::class, $resources->data[0]);
    }
    ...
    public function testAllRefunds()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Epayco\ApplicationFeeRefund::class, $resources->data[0]);
    }
    ...
    public function testCreateRefund()
    {
        ...
        static::assertInstanceOf(\Epayco\ApplicationFeeRefund::class, $resource);
    }
    ...
    public function testRetrieve()
    {
        ...
        static::assertInstanceOf(\Epayco\ApplicationFee::class, $resource);
    }

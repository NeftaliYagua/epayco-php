...
/**
 * @internal
 * @covers \Epayco\Service\CustomerService
 */
final class CustomerServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\Customer::class, $resources->data[0]);
    }
    ...
    public function testAllBalanceTransactions()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Epayco\CustomerBalanceTransaction::class, $resources->data[0]);
    }
    ...
    public function testAllSources()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Epayco\AlipayAccount::class, $resources->data[0]);
    }
    ...
    public function testAllTaxIds()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Epayco\TaxId::class, $resources->data[0]);
    }
    ...
    public function testCreate()
    {
        ...
        static::assertInstanceOf(\Epayco\Customer::class, $resource);
    }
    ...
    public function testCreateBalanceTransaction()
    {
        ...
        static::assertInstanceOf(\Epayco\CustomerBalanceTransaction::class, $resource);
    }
    ...
    public function testCreateTaxId()
    {
        ...
        $resource = $this->service->createTaxId(self::TEST_RESOURCE_ID, [
            'type' => \Epayco\TaxId::TYPE_EU_VAT,
            'value' => '11111',
        ]);
        static::assertInstanceOf(\Epayco\TaxId::class, $resource);
    }

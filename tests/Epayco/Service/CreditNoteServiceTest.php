...
/**
 * @internal
 * @covers \Epayco\Service\CreditNoteService
 */
final class CreditNoteServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\CreditNote::class, $resources->data[0]);
    }
    ...
    public function testAllLines()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Epayco\CreditNoteLineItem::class, $resources->data[0]);
    }
    ...
    public function testCreate()
    {
        ...
        static::assertInstanceOf(\Epayco\CreditNote::class, $resource);
    }

...
/**
 * @internal
 * @covers \Epayco\Service\PaymentIntentService
 */
final class PaymentIntentServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Epayco\PaymentIntent::class, $resources->data[0]);
    }
    ...
    public function testCancel()
    {
        ...
        static::assertInstanceOf(\Epayco\PaymentIntent::class, $resource);
    }

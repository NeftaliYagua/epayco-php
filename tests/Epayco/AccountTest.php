...
final class AccountTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testIsDeauthorizable()
    {
        ...
        $this->stubRequest(
            ...
            '/oauth/deauthorize',
            [
                'client_id' => Epayco::getClientId(),
                'epayco_user_id' => $resource->id,
            ],
            null,
            false,
            [
    ...
    public function testPersons()
    {
        ...
        static::assertInstanceOf(\Epayco\Person::class, $persons->data[0]);
    }
    ...
    public function testSerializeNewAdditionalOwners()
    {
        $obj = Util\Util::convertToEpaycoObject([
            'object' => 'account',
            'legal_entity' => EpaycoObject::constructFrom([]),
        ], null);
    ...
    public function testSerializeAddAdditionalOwners()
    {
        $obj = Util\Util::convertToEpaycoObject([
            ...
            'legal_entity' => [
                'additional_owners' => [
                    EpaycoObject::constructFrom(['first_name' => 'Joe']),
                    EpaycoObject::constructFrom(['first_name' => 'Jane']),
                ],
            ],
        ], null);
    ...
    public function testSerializePartiallyChangedAdditionalOwners()
    {
        ...
        $obj->legal_entity->additional_owners[1]->first_name = 'Epayco';
    ...
    public function testSerializePartiallyChangedIndividual()
    {
        $obj = Util\Util::convertToEpaycoObject([
            'object' => 'account',
            'individual' => Util\Util::convertToEpaycoObject([
                'object' => 'person',
                'first_name' => 'Jenny',
            ], null),
        ], null);

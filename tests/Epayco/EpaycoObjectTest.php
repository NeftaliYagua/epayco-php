...
/**
 * @internal
 * @covers \Epayco\EpaycoObject
 */
final class EpaycoObjectTest extends \PHPUnit\Framework\TestCase
{
    use TestHelper;
    ...
    public function setUpReflectors()
    {
        ...
        $this->deepCopyReflector = new \ReflectionMethod(\Epayco\EpaycoObject::class, 'deepCopy');
    ...
    public function testToArray()
    {
        ...
        $s = EpaycoObject::constructFrom($array);
    ...
    public function testToArrayRecursive()
    {
        ...
        $nested = EpaycoObject::constructFrom($nestedArray);

        $obj = EpaycoObject::constructFrom([
            'id' => 1,
            // simple associative array that contains a EpaycoObject to help us
            // test deep recursion
    ...
    public function testNonexistentProperty()
    {
        ...
        try {
            ...
            static::assertRegExp(
                '/Epayco Notice: Undefined property of Epayco\\\\EpaycoObject instance: nonexistent/',
...
EOS;
    ...
    {
        $obj = EpaycoObject::constructFrom(['foo' => null]);
    ...
    {
        $obj = EpaycoObject::constructFrom([
            'foo' => EpaycoObject::constructFrom([
                'bar' => null,
                'baz' => null,
            ]),
        ]);
    ...
    public function testSerializeParametersOnArrayOfHashes()
    {
        $obj = EpaycoObject::constructFrom(['foo' => null]);
        $obj->foo = [
            EpaycoObject::constructFrom(['bar' => null]),
        ];
    ...
    public function testSerializeParametersWithEpaycoObject()
    {
        $obj = EpaycoObject::constructFrom([]);
        $obj->metadata = EpaycoObject::constructFrom(['foo' => 'bar']);

        $serialized = $obj->serializeParameters();
        static::assertSame(['foo' => 'bar'], $serialized['metadata']);
    }

    public function testSerializeParametersOnReplacedEpaycoObject()
    {
        $obj = EpaycoObject::constructFrom([
            'source' => EpaycoObject::constructFrom(['bar' => 'foo']),
        ]);
        $obj->source = EpaycoObject::constructFrom(['baz' => 'foo']);

        $serialized = $obj->serializeParameters();
        static::assertSame(['baz' => 'foo'], $serialized['source']);
    }

    public function testSerializeParametersOnReplacedEpaycoObjectWhichIsMetadata()
    {
        $obj = EpaycoObject::constructFrom([
            'metadata' => EpaycoObject::constructFrom(['bar' => 'foo']),
        ]);
        $obj->metadata = EpaycoObject::constructFrom(['baz' => 'foo']);

        $serialized = $obj->serializeParameters();
        static::assertSame(['bar' => '', 'baz' => 'foo'], $serialized['metadata']);
    }

    public function testSerializeParametersOnArrayOfEpaycoObjects()
    {
        $obj = EpaycoObject::constructFrom([]);
        $obj->metadata = [
            EpaycoObject::constructFrom(['foo' => 'bar']),
        ];
    ...
    {
        $customer = Customer::constructFrom(['id' => 'cus_123']);
        $obj = EpaycoObject::constructFrom(['customer' => $customer]);
    ...
    public function testSerializeParametersRaisesExceotionOnOtherEmbeddedApiResources()
    {
        ...
        try {
            ...
            static::assertSame(
                'Cannot save property `customer` containing an API resource of type Epayco\\Customer. ' .
    ...
    public function testSerializeParametersForce()
    {
        $obj = EpaycoObject::constructFrom([
            'id' => 'id',
            'metadata' => EpaycoObject::constructFrom([
                'bar' => 'foo',
            ]),
        ]);
    ...
    public function testDeepCopy()
    {
        ...
        $values = [
            ...
            'name' => 'Epayco',
            'arr' => [
                EpaycoObject::constructFrom(['id' => 'index0'], $opts),
                'index1',
                2,
            ],
            'map' => [
                '0' => EpaycoObject::constructFrom(['id' => 'index0'], $opts),
                '1' => 'index1',
                '2' => 2,
            ],
        ];
        ...
        // internal values of the copied EpaycoObject should be the same,
    ...
    public function testIsDeleted()
    {
        ...
        $obj = EpaycoObject::constructFrom(['deleted' => false]);
        static::assertFalse($obj->isDeleted());

        $obj = EpaycoObject::constructFrom(['deleted' => true]);
    ...
    public function testDeserializeEmptyMetadata()
    {
        ...
        static::assertInstanceOf(\Epayco\EpaycoObject::class, $obj->metadata);
    }
